      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl border-t-8 border-red-600 p-5">
        ...
        <div className="mt-6 space-y-2">
          ...
          <a
            ...
            className="block text-center bg-green-600 text-white font-bold py-3 rounded-xl hover:bg-green-700 transition"
          >
          ...
          <a
            href="tel:131"
            className="block text-center bg-red-600 text-white font-bold py-3 rounded-xl hover:bg-red-700 transition"
          >
